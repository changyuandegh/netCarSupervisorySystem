...
public class StringAndDate {
    ...
    private static SimpleDateFormat datetime = new SimpleDateFormat(
            "yyyy-MM-dd HH:mm:ss");
    private static SimpleDateFormat datetimehour = new SimpleDateFormat(
            "yyyy-MM-dd HH");
    private static SimpleDateFormat yyMMddHHmmss = new SimpleDateFormat(
            "yyMMddHHmmss");
    ...
    /**
     * 获得以 yyMMddHHmmss 为形式的当前时间字符串
     *
     * @return
     */
    public static String getyyMMddHHmmss() {
        String time = yyMMddHHmmss.format(new Date());
        return time;
    }
    ...
    /**
     * 转换成日期格式的字符串 格式为yyyy-MM-dd HH
     *
     * @param o
     * @return
     */
    public static String dateFormatHour(Date o) {
        if (o == null) {
            return "";
        }
        return datetimehour.format(o);
    }
     ...
     * @return long
     */
    public static long getDateFromStr2(String dateStr) {
        long temp = 0L;
        Date date = null;
        try {
    ...
    public static long getDateFromStr(String dateStr) {
        ...
        Date date = null;
        try {
            date = yyMMddHHmmss.parse(dateStr);
        } catch (Exception e) {
            e.printStackTrace();
            return temp;
        }
     ...
     * @throws ParseException
     */
    public static String plusDay(Date newDate, int num) throws ParseException {
        String newDateS = dateTimeFormat(newDate);
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Date currdate = format.parse(newDateS);
