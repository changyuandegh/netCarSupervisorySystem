...
public class NetDriverphoto {
    ...
    public void setDriverphotoid(String driverphotoid) {
    ...
    public boolean equals(Object o) {
        ...
        NetDriverphoto that = (NetDriverphoto) o;
        return id == that.id &&
                Objects.equals(driverphotoid, that.driverphotoid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, driverphotoid, companyidc, address, createtime, photo, updatetime);
    }
}
