...
public class NetVehiclephoto {
    ...
    public String getVehiclephotoid() {
        return vehiclephotoid;
    }

    public void setVehiclephotoid(String vehiclephotoid) {
    ...
    public boolean equals(Object o) {
        ...
        NetVehiclephoto that = (NetVehiclephoto) o;
        return id == that.id &&
                Objects.equals(vehiclephotoid, that.vehiclephotoid) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, vehiclephotoid, companyidc, address, createtime, photo, updatetime);
    }
}
